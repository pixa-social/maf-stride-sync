            ...
            {days.map(day => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "aspect-square rounded-lg p-2 text-sm font-medium transition-all hover:scale-105",
          ...
          <Card className="bg-gradient-card border-0 shadow-soft p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div>
                ...
                <p className="text-2xl font-bold text-primary">{selectedDay.totalSteps.toLocaleString()}</p>
              </div>
              <div>
                <p className="text-sm text-muted-foreground">Distance</p>
                <p className="text-2xl font-bold text-secondary">{selectedDay.totalDistance.toFixed(2)} km</p>
              </div>
              <div>
                <p className="text-sm text-muted-foreground">Duration</p>
                <p className="text-2xl font-bold">{selectedDay.totalDuration} min</p>
              </div>
              <div>
                <p className="text-sm text-muted-foreground">MAF Time</p>
                <p className="text-2xl font-bold text-success">{selectedDay.timeInMAFZone} min</p>
              </div>
            </div>
